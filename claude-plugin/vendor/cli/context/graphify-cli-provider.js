...
export class GraphifyCliProvider {
    ...
    async initialize(projectRoot) {
        ...
        this.graphPath = resolveInsideProject(this.projectRoot, this.options.graphPath ?? "graphify-out/graph.json");
    }
    ...
    async runGraphify(args, cwd, operation, signal) {
...
function extractRelevantFiles(output, projectRoot) {
...
function resolveInsideProject(projectRoot, path) {
...
async function assertPathTargetInsideProject(projectRoot, path) {
...
async function snapshotForGraph(provider, graphPath, incremental, prebuilt) {
...
//# sourceMappingURL=graphify-cli-provider.js.map