...
export async function evaluateCompletionConditions(conditions, adapterResult, options) {
    const evidence = [];
...
async function evaluateCondition(condition, conditionIndex, adapterResult, options) {
    ...
    switch (condition.type) {
        ...
        case "assertion": {
            const matchingEvidence = adapterResult.completionEvidence.find((entry) => entry.conditionIndex === conditionIndex && entry.passed);
            return {
                conditionIndex,
                ...
                evidence: {
                    ...
                    reason: matchingEvidence === undefined
...
async function runCommand(command, cwd, outputLimit = 8_000) {
