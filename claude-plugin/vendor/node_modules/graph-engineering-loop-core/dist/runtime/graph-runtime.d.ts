...
import type { ConditionEvidence, GraphStatus, HarnessAdapter, LoopGraph, LoopResult, LoopStatus } from "../schema/types.js";
...
export declare class GraphRuntime {
    ...
    private readonly loopOrder;
    private readonly states;
    private readonly results;
    private readonly loopProjectRoots;
    private readonly maxConcurrentLoops;
    private readonly projectGraphProvider?;
    private readonly worktreeManager?;
    private readonly integrationSupervisor?;
    private readonly isolatedLoopIds;
    private readonly maxOverlapRatio?;
    private readonly hooks;
    constructor(options: GraphRuntimeOptions);
    run(signal?: AbortSignal): Promise<GraphRunResult>;
    private runLoop;
    private prepareProjectGraphContext;
    private toLoopResult;
    private refreshStatuses;
    private getReadyLoops;
    private selectStartableLoops;
    private loopById;
    private touchPlanFor;
    private prepareLoopWorkspace;
    private integrateCompletedLoops;
    private effectiveProjectRoot;
    private getDependencyResults;
    private effectiveConcurrencyLimit;
    private isTerminal;
    private blockUnreachableLoops;
